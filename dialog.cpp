...
Dialog::~Dialog(){delete new_UiDialog;}
...
void Dialog::finish_edit()
{
    ...
    if(new_UiDialog->NewTableWidget->item(currentTableRow,1) == NULL){return;}
    ...
    }else if(new_UiDialog->NewTableWidget->item(currentTableRow,2) == NULL && new_UiDialog->NewTableWidget->item(currentTableRow+1,0) == NULL &&
       new_UiDialog->NewTableWidget->item(currentTableRow+1,1) != NULL && new_UiDialog->NewTableWidget->item(currentTableRow+1,2) != NULL ){
        currentTableRow++;
